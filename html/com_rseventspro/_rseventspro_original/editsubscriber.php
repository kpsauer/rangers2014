...
<fieldset class="rs_fieldset">
	...
	<table cellspacing="0" cellpadding="3" border="0" class="rs_table">
		...
		<tr>
			<td width="160">&nbsp;</td>
			<td><a class="rs_modal" rel="{handler: 'iframe', size: {x:1280,y:800}}" href="<?php echo rseventsproHelper::route('index.php?option=com_rseventspro&layout=userseats&tmpl=component&id='.rseventsproHelper::sef($subscriber->id,$subscriber->name)); ?>"><?php echo JText::_('COM_RSEVENTSPRO_SEATS_CONFIGURATION'); ?></a></td>
		</tr>
		<?php } ?>
		<tr>
